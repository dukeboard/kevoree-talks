...
class UbiMob2012Activator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { UbiMob2012Factory.createComponentActor() } }
