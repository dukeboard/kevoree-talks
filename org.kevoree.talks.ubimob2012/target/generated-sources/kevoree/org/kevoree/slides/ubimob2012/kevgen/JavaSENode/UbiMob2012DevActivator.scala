...
class UbiMob2012DevActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { UbiMob2012DevFactory.createComponentActor() } }
